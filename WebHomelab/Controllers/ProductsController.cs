...
namespace WebHomelab.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            {
    /*            var auditIdParam = new SqlParameter("@AuditIdParam", SqlDbType.Int);
            ...
            /*    auditIdParam.Value = product.ProductId;
                ...
                await _context.Database.ExecuteSqlCommandAsync("EXEC usp_InsertAudit @AuditIdParam,@NameParam,@ProductNumberParam,@MakeFlagParam,@FinishedGoodsFlagParam, @ColorParam, " +
                    "@SafetyStockLevelParam, @ReorderPointParam, @StandardCostParam, @ListPriceParam, @SizeParam, @SizeUnitMeasureCodeParam, @WeightUnitMeasureCodeParam, @WeightParam,@WeightParam," +
                    " @DaysToManufactureParam,@ProductLineParam, @ClassParam, @StyleParam, @ProductSubcategoryIdParam, @ProductModelIdParam, @SellStartDateParam, @SellEndDateParam,@UserIdentifierParam" +
                    " @DiscontinuedDateParam, @ModifiedDateParam, @ModifiedDateParam,",
